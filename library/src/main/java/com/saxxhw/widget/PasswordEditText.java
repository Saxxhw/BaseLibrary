...
public class PasswordEditText extends AppCompatEditText {
    ...
    private Drawable[] mDrawables;  // 全部图片
    ...
    private void showPasswordVisibilityIndicator(boolean shouldShowIcon) {
        if (shouldShowIcon) {
            int mShowPwdIcon = R.mipmap.ic_password_show;
            int mHidePwdIcon = R.mipmap.ic_password_not_show;
    ...
    // 存储密码状态, 显示Icon的位置
    private static class PwdSavedState extends BaseSavedState {
